set -euo pipefail
RECOVERY_ROOT=/mnt/nfs/home/mohamadzbib/projects/rl-infra/recoveries/3b-stale6-normal-retry-20260919
EXPERIMENT_ROOT=/mnt/nfs/home/mohamadzbib/projects/rl-infra/experiments/dapo-qwen25-3b-grpo-stale6-4gpu-tp2
RL_INFRA=/mnt/nfs/home/mohamadzbib/projects/rl-infra
RUN_NAME=qwen25-3b-grpo-seed42-stale6-4gpu-tp2
ATTEMPT_ID="job-$SLURM_JOB_ID-restart-${SLURM_RESTART_COUNT:-0}"
RUN_DIR="$RL_INFRA/outputs/dapo-qwen25-3b-grpo-stale6-4gpu-tp2/$RUN_NAME"
OBSERVER_DIR="$RL_INFRA/outputs/dapo-qwen25-3b-grpo-stale6-4gpu-tp2-observer/$RUN_NAME"
RECOVERY_DIR="$RL_INFRA/outputs/dapo-qwen25-3b-grpo-stale6-4gpu-tp2-recovery/$RUN_NAME"
...
MODEL_LINK=/mnt/xfs/home/mohamadzbib/projects/models/qwen25-3b-grpo-seed42-stale6-4gpu-tp2
MODEL_SOURCE=/mnt/nfs/home/mohamadzbib/projects/models/Qwen2.5-3B-3aab1f19
ACTIVE_PID=
stop_active() {
...
verify_credentials() (
    ...
    export OPIK_PROJECT_NAME=qwen25-3b-grpo-stale6-4gpu
)
...
if test "$TRAINING_FINISHED" = false; then
    ...
    run_guarded timeout --signal=TERM --kill-after=15s 240s uv run --no-sync torchrun --standalone --nproc-per-node=3 "$RECOVERY_ROOT/health_probe.py" --mapping "$GPU_MAPPING"
