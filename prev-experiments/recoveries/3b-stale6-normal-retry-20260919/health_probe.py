...
def main():
    ...
    require(torch.cuda.device_count() == GPU_COUNT, "The allocation must expose exactly three CUDA GPUs")
    ...
    try:
        ...
        require(world_size == GPU_COUNT, "Health probe requires exactly three ranks")
