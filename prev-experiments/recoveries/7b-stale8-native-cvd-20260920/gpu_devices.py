...
def bind_visible_devices(cvd, allocated, visible, physical):
    ...
    require(len(selectors) == GPU_COUNT, "Expected five original Slurm visible selectors")
...
def inspect_assignment():
    require(socket.gethostname().split(".")[0] == "deep-chungus-11", "Native-selector recovery is pinned to deep-chungus-11 only")
