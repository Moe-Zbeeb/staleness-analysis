...
class MappingTests(unittest.TestCase):
    ...
    def test_altered_original_assignment_rejected_before_cuda_query(self):
        ...
        with patch.dict(os.environ, environment, clear=True), patch('gpu_devices.socket.gethostname', return_value='deep-chungus-11'), patch('gpu_devices.visible_inventory') as query:
