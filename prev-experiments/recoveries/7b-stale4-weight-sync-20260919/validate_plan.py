...
report = {
    ...
    'runtime_provenance_sha256': digest(root / 'runtime-provenance.json'),
    'runtime_source_manifest_sha256': digest(root / 'prime-rl-source-manifest.json'),
    'shared_prime_repository_modified': False,
}
recovery.static()
