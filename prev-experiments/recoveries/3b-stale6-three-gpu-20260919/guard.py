...
OVERLAY = {'deployment': {'gpus_per_node': 3, 'num_train_gpus': 2, 'num_infer_gpus': 1}, 'inference': {'vllm': {'tensor_parallel_size': 1}}}
...
class Recovery:
    ...
    def static(self):
        ...
        require(tomllib.loads(self.overlay.read_text()) == OVERLAY, 'Recovery changes settings beyond the declared three-GPU topology')
