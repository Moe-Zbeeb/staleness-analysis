...
SMOKE_NAME="qwen25-3b-grpo-seed42-stale8-6gpu-smoke-$SLURM_JOB_ID-attempt-${SLURM_RESTART_COUNT:-0}"
SMOKE_DIR="$RL_INFRA/outputs/dapo-qwen25-3b-grpo-stale8-6gpu/$SMOKE_NAME"
