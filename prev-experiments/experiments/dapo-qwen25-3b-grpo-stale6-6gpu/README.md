# Qwen2.5-3B GRPO, staleness cap 6
...
The inclusive rollout staleness cap is 6. Run identity, checkpoints, recovery state and Comet/Opik project are isolated under `qwen25-3b-grpo-stale6-6gpu`.
