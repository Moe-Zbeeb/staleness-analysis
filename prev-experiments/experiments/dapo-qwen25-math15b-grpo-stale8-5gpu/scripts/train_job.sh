...
RUN_NAME=qwen25-math15b-grpo-seed42-stale8-5gpu
ATTEMPT_ID="job-$SLURM_JOB_ID-restart-${SLURM_RESTART_COUNT:-0}"
RUN_DIR="$RL_INFRA/outputs/dapo-qwen25-math15b-grpo-stale8-5gpu/$RUN_NAME"
OBSERVER_DIR="$RL_INFRA/outputs/dapo-qwen25-math15b-grpo-stale8-5gpu-observer/$RUN_NAME"
RECOVERY_DIR="$RL_INFRA/outputs/dapo-qwen25-math15b-grpo-stale8-5gpu-recovery/$RUN_NAME"
...
MODEL_LINK=/mnt/xfs/home/mohamadzbib/projects/models/qwen25-math15b-grpo-seed42-stale8-5gpu
...
verify_credentials() (
    ...
    export OPIK_PROJECT_NAME=qwen25-math15b-grpo-stale8-5gpu
)
