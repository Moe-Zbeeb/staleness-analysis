set -euo pipefail
EXPERIMENT_ROOT=/mnt/nfs/home/mohamadzbib/projects/rl-infra/experiments/dapo-qwen25-math7b-grpo-stale6-9gpu
RL_INFRA=/mnt/nfs/home/mohamadzbib/projects/rl-infra
RUN_NAME=qwen25-math7b-grpo-seed42-stale6-9gpu
ATTEMPT_ID="job-$SLURM_JOB_ID-restart-${SLURM_RESTART_COUNT:-0}"
RUN_DIR="$RL_INFRA/outputs/dapo-qwen25-math7b-grpo-stale6-9gpu/$RUN_NAME"
OBSERVER_DIR="$RL_INFRA/outputs/dapo-qwen25-math7b-grpo-stale6-9gpu-observer/$RUN_NAME"
RECOVERY_DIR="$RL_INFRA/outputs/dapo-qwen25-math7b-grpo-stale6-9gpu-recovery/$RUN_NAME"
...
MODEL_LINK=/mnt/xfs/home/mohamadzbib/projects/models/qwen25-math7b-grpo-seed42-stale6-9gpu
...
verify_credentials() (
    ...
    export OPIK_PROJECT_NAME=qwen25-math7b-grpo-stale6-9gpu
)
