...
SMOKE_NAME="qwen3-14b-grpo-seed42-stale0-smoke-$SLURM_JOB_ID-attempt-${SLURM_RESTART_COUNT:-0}"
SMOKE_DIR="$RL_INFRA/outputs/dapo-qwen3-14b-grpo-stale0/$SMOKE_NAME"
