...
timeout -k 15 240 uv run --no-sync torchrun --standalone --nproc-per-node=8 "$EXPERIMENT_ROOT/scripts/health_probe.py"
...
SMOKE_NAME="qwen25-math7b-grpo-seed42-stale8-8h100-smoke-$SLURM_JOB_ID-attempt-${SLURM_RESTART_COUNT:-0}"
SMOKE_DIR="$RL_INFRA/outputs/dapo-qwen25-math7b-grpo-stale8-8h100/$SMOKE_NAME"
