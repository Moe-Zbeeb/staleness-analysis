...
RUN_NAME=qwen3-14b-grpo-seed42
ATTEMPT_ID="job-$SLURM_JOB_ID-restart-${SLURM_RESTART_COUNT:-0}"
RUN_DIR="$RL_INFRA/outputs/dapo-qwen3-14b-grpo/$RUN_NAME"
OBSERVER_DIR="$RL_INFRA/outputs/dapo-qwen3-14b-grpo-observer/$RUN_NAME"
RECOVERY_DIR="$RL_INFRA/outputs/dapo-qwen3-14b-grpo-recovery/$RUN_NAME"
...
MODEL_LINK=/mnt/xfs/home/mohamadzbib/projects/models/qwen3-14b-grpo-seed42
...
verify_credentials() (
    ...
    export OPIK_PROJECT_NAME=qwen3-14b-grpo
)
