set -euo pipefail
EXPERIMENT_ROOT=/mnt/nfs/home/mohamadzbib/projects/rl-infra/experiments/dapo-qwen25-3b-grpo-stale6-4gpu
RL_INFRA=/mnt/nfs/home/mohamadzbib/projects/rl-infra
RUN_NAME=qwen25-3b-grpo-seed42-stale6-4gpu
ATTEMPT_ID="job-$SLURM_JOB_ID-restart-${SLURM_RESTART_COUNT:-0}"
RUN_DIR="$RL_INFRA/outputs/dapo-qwen25-3b-grpo-stale6-4gpu/$RUN_NAME"
OBSERVER_DIR="$RL_INFRA/outputs/dapo-qwen25-3b-grpo-stale6-4gpu-observer/$RUN_NAME"
RECOVERY_DIR="$RL_INFRA/outputs/dapo-qwen25-3b-grpo-stale6-4gpu-recovery/$RUN_NAME"
...
MODEL_LINK=/mnt/xfs/home/mohamadzbib/projects/models/qwen25-3b-grpo-seed42-stale6-4gpu
