...
SMOKE_NAME="qwen25-3b-grpo-seed42-stale6-4gpu-smoke-$SLURM_JOB_ID-attempt-${SLURM_RESTART_COUNT:-0}"
SMOKE_DIR="$RL_INFRA/outputs/dapo-qwen25-3b-grpo-stale6-4gpu/$SMOKE_NAME"
