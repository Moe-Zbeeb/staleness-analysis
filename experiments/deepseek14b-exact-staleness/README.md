...
**Status:** production job **2144962** was stopped at the user's request before any completed optimizer update was recorded. Its outputs are preserved. The corrected fresh run uses [exact256-80gb-seed42-v2.json](configs/exact256-80gb-seed42-v2.json), with the same 1,000-update budget, exact lag 256 and eight-A100-80GB profile. See the [relaunch record](docs/runs/exact256-v2.md) and [grading review](docs/grading-review.md).
