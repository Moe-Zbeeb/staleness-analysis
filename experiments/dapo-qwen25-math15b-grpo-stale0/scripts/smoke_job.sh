...
uv run --no-sync torchrun --standalone --nproc-per-node=5 "$EXPERIMENT_ROOT/scripts/health_probe.py"
...
SMOKE_NAME="qwen25-math15b-grpo-seed42-stale0-smoke-$SLURM_JOB_ID-attempt-${SLURM_RESTART_COUNT:-0}"
SMOKE_DIR="$RL_INFRA/outputs/dapo-qwen25-math15b-grpo-stale0/$SMOKE_NAME"
