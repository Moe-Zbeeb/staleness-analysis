...
SMOKE_NAME="qwen25-math15b-grpo-seed42-stale8-3gpu-smoke-$SLURM_JOB_ID-attempt-${SLURM_RESTART_COUNT:-0}"
SMOKE_DIR="$RL_INFRA/outputs/dapo-qwen25-math15b-grpo-stale8-3gpu/$SMOKE_NAME"
