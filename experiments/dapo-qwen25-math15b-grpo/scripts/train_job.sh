...
RUN_NAME=qwen25-math15b-grpo-seed42
ATTEMPT_ID="job-$SLURM_JOB_ID-restart-${SLURM_RESTART_COUNT:-0}"
RUN_DIR="$RL_INFRA/outputs/dapo-qwen25-math15b-grpo/$RUN_NAME"
OBSERVER_DIR="$RL_INFRA/outputs/dapo-qwen25-math15b-grpo-observer/$RUN_NAME"
RECOVERY_DIR="$RL_INFRA/outputs/dapo-qwen25-math15b-grpo-recovery/$RUN_NAME"
...
MODEL_LINK=/mnt/xfs/home/mohamadzbib/projects/models/qwen25-math15b-grpo-seed42
...
verify_credentials() (
    ...
    export OPIK_PROJECT_NAME=qwen25-math15b-grpo
)
...
test "${#GPU_IDS[@]}" -eq 5
PRIME_VISIBLE_DEVICES="${GPU_IDS[3]},${GPU_IDS[4]},${GPU_IDS[0]},${GPU_IDS[1]},${GPU_IDS[2]}"
